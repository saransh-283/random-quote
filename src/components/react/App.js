    ...
    return (
      <div className="card" >
        <div className="card-body">
          ...
          <footer id="footer">
            <div id="social-btns">
              <a href={"https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=%22"+this.state.text.split(' ').join('%20')+"%22%20-"+this.state.author.split(' ').join('%20')} className="btn social-btn" id="twitter"><i className="fa fa-twitter" aria-hidden="true"></i></a>
